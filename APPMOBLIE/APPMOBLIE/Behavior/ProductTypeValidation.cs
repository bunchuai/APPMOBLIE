...
{
    class ProductTypeValidation : Behavior<Entry>
    {
        protected static readonly BindablePropertyKey bindablePropertyKey = BindableProperty.CreateReadOnly("IsValid", typeof(bool), typeof(ProductTypeValidation), false);
